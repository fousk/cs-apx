...
namespace UnitTestCsApx
{
    ...
    public class Test_encode_decode
    {
        ...
        public void encode_32()
        {
            ...
            //8b
            res = NumHeader._encode(0, 32).ToArray();
            Assert.IsTrue(res.SequenceEqual(new byte[] { 0x00 }));
            res = NumHeader._encode(0x7F, 32).ToArray();
